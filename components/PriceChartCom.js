...
export default function PriceChartCom({ instId = 'BTC-USD', parentScrollviewRef }) {
    ...
    return <View style={{ marginVertical: 10 }}>
        ...
        <View  {...panResponder[0]?.panHandlers} pointerEvents="box-none">
            <LineChart
                ...
                getDotColor={(data, index) => {
                    ...
                    return data == Math.floor(_selectPointData[0][4]) ? 'green' : 'transparent'
                }}
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-around', backgroundColor: 'rgba(0,0,0,0.1)', padding: 2, borderRadius: 8, marginTop: '0%', width: "90%", marginHorizontal: '5%' }}>

            <View style={{ backgroundColor: selectDate[0] == '30m' ? '#fff' : 'transparent', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8, flex: 1, marginRight: 5 }}>
                <Pressable onPress={() => changeDate('30m')}>
                    <Text style={{ textAlign: 'center' }}>1D</Text>
                </Pressable>
            </View>
            <View style={{ backgroundColor: selectDate[0] == '1H' ? '#fff' : 'transparent', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8, flex: 1, marginRight: 5 }}>
                <Pressable onPress={() => changeDate('1H')}>
                    <Text style={{ textAlign: 'center' }}>1W</Text>
                </Pressable>
            </View>
            <View style={{ backgroundColor: selectDate[0] == '1D' ? '#fff' : 'transparent', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8, flex: 1, marginRight: 5 }}>
                <Pressable onPress={() => changeDate('1D')}>
                    <Text style={{ textAlign: 'center' }}>1M</Text>
                </Pressable>
            </View>
            <View style={{ backgroundColor: selectDate[0] == '1W' ? '#fff' : 'transparent', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8, flex: 1 }}>
