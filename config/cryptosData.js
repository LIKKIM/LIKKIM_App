...
export const initialAdditionalCryptos = [
  ...
  // Polygon (MATIC)
  {
    ...
    shortName: "MATIC",
    balance: "0.0",
    // icon: require("../assets/icon/MATICIcon.png"),
    // cardImage: require("../assets/CardPolygon.png"),
    address: "0xxyz...",
    chain: "Polygon",
    chainShortName: "MATIC",
    queryChainShortName: "MATIC",
    // chainIcon: require("../assets/icon/MATICIcon.png"),
    tokenType: "ERC20",
    fee: "0.001",
    valueUsd: "0.0",
    priceUsd: "1.0",
  ...
  },
  {
    ...
    // cardImage: require("../assets/CardSolana.png"),
    address: "sol1xyz...",
    chain: "Solana",
    chainShortName: "SOL",
  ...
  // Nervos (CKB)
  {
    ...
    shortName: "CKB",
    balance: "0.0",
    // icon: require("../assets/icon/CKBIcon.png"),
    // cardImage: require("../assets/CardNervos.png"),
    address: "ckb1xyz...",
    chain: "Nervos",
    chainShortName: "CKB",
    queryChainShortName: "CKB",
    // chainIcon: require("../assets/icon/CKBIcon.png"),
    tokenType: "CKB",
    fee: "0.0001",
    valueUsd: "0.0",
    priceUsd: "0.02",
  ...
  // Osmosis
  {
    ...
    shortName: "OSMO",
    balance: "0.0",
    // icon: require("../assets/icon/OsmosisIcon.png"),
    // cardImage: require("../assets/CardOsmosis.png"),
    address: "osmo1xyz...",
    chain: "Osmosis",
    chainShortName: "OSMO",
    queryChainShortName: "OSMO",
    // chainIcon: require("../assets/icon/OsmosisIcon.png"),
    tokenType: "OSMO",
    fee: "0.001",
    valueUsd: "0.0",
    priceUsd: "1.0",
  ...
  // Ronin
  {
    ...
    shortName: "RON",
    balance: "0.0",
    // icon: require("../assets/icon/RoninIcon.png"),
    // cardImage: require("../assets/CardRonin.png"),
    address: "ronin1xyz...",
    chain: "Ronin",
    chainShortName: "RON",
    queryChainShortName: "RON",
    // chainIcon: require("../assets/icon/RoninIcon.png"),
    tokenType: "RON",
    fee: "0.001",
    valueUsd: "0.0",
    priceUsd: "1.0",
