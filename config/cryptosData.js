...
export const initialAdditionalCryptos = [
  ...
  },
  {
    ...
    shortName: "USDT",
    balance: "0.0",
    icon: require("../assets/icon/TetherIcon.png"),
  ...
  // Gnosis Chain (GNO)
  {
    ...
    cardImage: require("../assets/CardBg/Card17.png"),
    address: "0xxyz...",
    chain: "Gnosis Chain",
    chainShortName: "GNO",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card19.png"),
    address: "0xxyz...",
    chain: "Linea",
    chainShortName: "LINA",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card20.png"),
    address: "0xxyz...",
    chain: "Mantle",
    chainShortName: "MNT",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card23.png"),
    address: "0xxyz...",
    chain: "Base",
    chainShortName: "BASE",
  ...
  // SUI (SUI)
  {
    ...
    cardImage: require("../assets/CardBg/Card25.png"),
    address: "sui1xyz...",
    chain: "SUI",
    chainShortName: "SUI",
  ...
  // Aptos (APT)
  {
    ...
    cardImage: require("../assets/CardBg/Card26.png"),
    address: "aptos1xyz...",
    chain: "Aptos",
    chainShortName: "APT",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card27.png"),
    address: "43xyz...",
    chain: "Monero",
    chainShortName: "XMR",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card28.png"),
    address: "kusama1xyz...",
    chain: "Kusama",
    chainShortName: "KSM",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card29.png"),
    address: "astar1xyz...",
    chain: "Astar",
    chainShortName: "ASTR",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card31.png"),
    address: "fxyz...",
    chain: "Filecoin",
    chainShortName: "FIL",
  ...
  // Cronos (CRO)
  {
    ...
    cardImage: require("../assets/CardBg/Card33.png"),
    address: "cro1xyz...",
    chain: "Cronos",
    chainShortName: "CRO",
  ...
  // Crypto.org (CRO)
  {
    ...
    cardImage: require("../assets/CardBg/Card34.png"),
    address: "cro1xyz...",
    chain: "Crypto.org",
    chainShortName: "CRO",
    queryChainShortName: "CRO",
  ...
  /*   {
    ...
    balance: "0.0",
    icon: require("../assets/icon/FILIcon.png"),
    cardImage: require("../assets/CardBg/Card39.png"),
    address: "fil1xyz...",
    chain: "Filecoin FEVM",
    chainShortName: "FIL",
    queryChainShortName: "FIL",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card42.png"),
    address: "cfx1xyz...",
    chain: "Conflux",
    chainShortName: "CFX",
  ...
  // Algorand (ALGO)
  {
    ...
    cardImage: require("../assets/CardBg/Card46.png"),
    address: "algo1xyz...",
    chain: "Algorand",
    chainShortName: "ALGO",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card47.png"),
    address: "akt1xyz...",
    chain: "Akash",
    chainShortName: "AKT",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card52.png"),
    address: "blast1xyz...",
    chain: "Blast",
  ...
  // Celestia (TIA)
  {
    ...
    cardImage: require("../assets/CardBg/Card53.png"),
    address: "tia1xyz...",
    chain: "Celestia",
    chainShortName: "TIA",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card59.png"),
    address: "0xxyz...",
    chain: "EthereumPoW",
    chainShortName: "ETHW",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card60.png"),
    address: "kas1xyz...",
    chain: "Kasp",
    chainShortName: "KAS",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card63.png"),
    address: "mvm1xyz...",
  ...
  // Near (NEAR)
  {
    ...
    cardImage: require("../assets/CardBg/Card64.png"),
    address: "near1xyz...",
    chain: "Near",
    chainShortName: "NEAR",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card65.png"),
    address: "ckb1xyz...",
    chain: "Nervos",
    chainShortName: "CKB",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card66.png"),
    address: "xna1xyz...",
    chain: "Neurai",
    chainShortName: "XNA",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card67.png"),
    address: "nexa1xyz...",
    chain: "Nexa",
    chainShortName: "NEXA",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card68.png"),
    address: "octa1xyz...",
    chain: "OctaSpace",
    chainShortName: "OCTA",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card69.png"),
    address: "opbnb1xyz...",
    chain: "opBNB",
  ...
  // Osmosis
  {
    ...
    cardImage: require("../assets/CardBg/Card70.png"),
    address: "osmo1xyz...",
    chain: "Osmosis",
    chainShortName: "OSMO",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card71.png"),
    address: "pls1xyz...",
    chain: "PulseChain",
    chainShortName: "PLS",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card72.png"),
    address: "zkevm1xyz...",
    chain: "Polygon Zkevm",
  ...
  /*  {
    ...
    cardImage: require("../assets/CardBg/Card73.png"),
    address: "ronin1xyz...",
    chain: "Ronin",
    chainShortName: "RON",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card74.png"),
    address: "scrl1xyz...",
    chain: "Scroll",
    chainShortName: "SCRL",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card75.png"),
    address: "taiko1xyz...",
    chain: "Taiko",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card76.png"),
    address: "wemix1xyz...",
    chain: "WEMIX3.0",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card77.png"),
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card79.png"),
    address: "zeta1xyz...",
    chain: "ZetaChain",
    chainShortName: "ZETA",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card82.png"),
    address: "tb1xyz...",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card85.png"),
    address: "holesky1xyz...",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card86.png"),
    address: "lntb1xyz...",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card87.png"),
    address: "end1xyz...",
    chain: "Endurance",
    chainShortName: "END",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card88.png"),
    address: "flr1xyz...",
    chain: "Flare",
    chainShortName: "FLR",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card89.png"),
    address: "one1xyz...",
    chain: "Harmony",
    chainShortName: "ONE",
  ...
  // Mobe
  {
    ...
    shortName: "MOBE",
    balance: "0.0",
    icon: require("../assets/icon/ModeIcon.png"),
    cardImage: require("../assets/CardBg/Card92.png"),
    address: "mobe1xyz...",
    chain: "Mobe",
    chainShortName: "MOBE",
    queryChainShortName: "MOBE",
    chainIcon: require("../assets/icon/ModeIcon.png"),
    tokenType: "MOBE",
    fee: "0.001",
    valueUsd: "0.0",
    priceUsd: "0.1",
  ...
  // Metis
  {
    ...
    cardImage: require("../assets/CardBg/Card93.png"),
    address: "metis1xyz...",
    chain: "Metis",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card95.png"),
    address: "nostr1xyz...",
    chain: "Nostr",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card96.png"),
    address: "kava1xyz...",
    chain: "Kava",
    chainShortName: "KAVA",
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card98.png"),
    address: "b21xyz...",
    chain: "B2 Mainnet",
    chainShortName: "B2",
 ...
 */
  ...
  /*   {
    ...
    cardImage: require("../assets/CardBg/Card99.png"),
    address: "bounce1xyz...",
    chain: "BounceBit",
