    ...
    resources: {
      ...
      ru: {
        translation: {
          ...
          Bluetooth: "Bluetooth",
          "Manage Paired Devices": "Управление сопряженными устройствами",
          "LOOKING FOR DEVICES": "ПОИСК УСТРОЙСТВ",
          "Scanning...": "Сканирование...",
          "Please make sure your Cold Wallet is unlocked and Bluetooth is enabled.":
            "Пожалуйста, убедитесь, что ваш холодный кошелек разблокирован и Bluetooth включен.",
          ...
          Balance: "Баланс",
          "No assets available. Please connect your device to continue.":
            "Нет доступных активов. Подключите устройство для продолжения.",
          "This asset card will be removed":
          ...
          Version: "Версия",
          "Assets can only be sent within the same chain.":
            "Активы можно отправлять только в пределах одной цепочки.",
          ...
          "Change App Screen Lock Password": "Сменить пароль блокировки экрана",
          ...
          "Enter PIN to Connect": "Введите PIN-код для подключения",
          "Use the PIN code to connect securely to your device.":
          ...
          "The verification code you entered is incorrect. Please try again.":
            "Введенный вами код неверен. Пожалуйста, попробуйте еще раз.",
          ...
          "Your secure and intuitive companion app.":
            "Ваше безопасное и интуитивно понятное приложение-компаньон.",
          "Screen lock enabled successfully":
          ...
          "To reset the app and remove stored data, please uninstall and reinstall it on your phone.":
            "Чтобы сбросить настройки приложения и удалить сохраненные данные, удалите его и установите заново.",
          ...
          "Your device is already verified.":
            "Ваше устройство уже подтверждено.",
          "Address Book": "Адресная книга",
          Convert: "Конвертировать",
          Skip: "Пропустить",
          "Start Exploring": "Начать исследование",
          "Secure and Reliable": "Безопасно и надежно",
          "Robust security designed for your information.":
            "Надежная безопасность для вашей информации.",
          "Easily manage multiple asset types.":
            "Легко управляйте несколькими типами активов.",
          ...
          "Permission denied, unable to access device location":
            "Доступ запрещен, невозможно определить местоположение устройства",
          "Last connected": "Последнее подключение",
          "Secure Device Status": "Статус защищенного устройства",
          "Device Settings": "Настройки устройства",
          "Reset Local Profile": "Сброс локального профиля",
          Support: "Поддержка",
          Warning: "Предупреждение",
          deleteDeviceConfirmMessage:
            "Вы уверены, что хотите удалить это устройство из приложения?\nЭто удалит все локально сохраненные данные, связанные с этим устройством.\n\nВы можете подключить устройство позже, чтобы повторно синхронизировать данные.\nУбедитесь, что вы сохранили всю важную информацию перед продолжением.",
          Delete: "Удалить",
          Success: "Успешно",
          ...
          addressShown: "Адрес успешно показан на вашем устройстве.",
          "Search Address": "Поиск адреса",
          "No device paired. Please pair with device first.":
            "Нет сопряженного устройства. Сначала выполните сопряжение.",
          All: "Все",
