    ...
    resources: {
      ...
      "zh-TW": {
        translation: {
          ...
          "Generating your accounts": "正在生成你的帳戶",
          "Encrypting your data": "正在加密你的資料",
          "Let's Go": "開始吧",
          ...
          "To reset the app and remove stored data, please uninstall and reinstall it on your phone.":
            "若要重設應用程式並移除儲存的資料，請在您的手機上卸載後重新安裝。",
          ...
          "No devices found": "未找到裝置，請配對裝置後查看。",
          ...
          "All Chains": "所有鏈",
          "Select Chain": "選擇鏈",
          "Contact Support via Email": "透過電子郵件聯絡支援",
          addressShown: "地址已成功顯示在您的裝置上。",
          "Search Address": "搜尋地址",
          "No device paired. Please pair with device first.":
            "未配對裝置。請先與裝置配對。",
          All: "全部",
          "Save to Device": "保存到裝置",
        },
      },
      fr: {
        translation: {
          ...
          "Select Chain": "Sélectionner une chaîne",
