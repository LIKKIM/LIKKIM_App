    ...
    resources: {
      ...
      ru: {
        translation: {
          ...
          "The verification code you entered is incorrect. Please try again.":
            "Введенный код неверен. Пожалуйста, попробуйте снова.",
          ...
          "To reset the app and remove stored data, please uninstall and reinstall it on your phone.":
            "Чтобы сбросить данные, удалите приложение и установите его заново.",
          "Estimated value (US$)": "Оценочная стоимость (US$)",
          Fee: "Комиссия",
          "Waiting for approval on your device...":
            "Ожидание одобрения на устройстве...",
          "Verifying address on your device...":
          ...
          "Easily manage multiple asset types.":
            "Легко управляйте разными активами.",
          ...
          "Permission denied, unable to access device location":
            "Доступ запрещен, невозможно получить местоположение устройства",
          ...
          deleteDeviceConfirmMessage:
            "Вы уверены, что хотите удалить это устройство из приложения?\nЭто удалит все локально сохраненные данные.\n\nВы сможете вновь подключить устройство для синхронизации.\nСохраните важную информацию перед продолжением.",
          Delete: "Удалить",
          Success: "Успешно",
          "Deleted successfully.": "Удаление прошло успешно.",
          ...
          addressShown: "Адрес успешно отображен на вашем устройстве.",
          "Search Address": "Поиск адреса",
          "No device paired. Please pair with device first.":
            "Устройство не сопряжено. Сначала выполните сопряжение.",
          All: "Все",
