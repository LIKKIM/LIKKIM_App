    ...
    resources: {
      ...
      it: {
        translation: {
          ...
          "Scanning...": "Scansione...",
          "Please make sure your Cold Wallet is unlocked and Bluetooth is enabled.":
            "Assicurati che il tuo Cold Wallet sia sbloccato e che il Bluetooth sia attivo.",
          "Manage Your Assets": "Gestisci i tuoi beni",
          Send: "Invia",
          Receive: "Ricevi",
          ...
          Balance: "Saldo",
          "No assets available. Please connect your device to continue.":
            "Nessun asset disponibile. Collega il tuo dispositivo per continuare.",
          "This asset card will be removed": "Questa scheda asset sarà rimossa",
          "Remove Asset Card": "Rimuovi scheda asset",
          Remove: "Rimuovi",
          "Security in your hands": "Sicurezza nelle tue mani",
          Continue: "Continua",
          "Scroll down to view all words": "Scorri per vedere tutte le parole",
          "Generating your accounts": "Generazione account in corso",
          "Encrypting your data": "Crittografia dei dati in corso",
          "Let's Go": "Iniziamo",
          "Use spaces between words": "Usa spazi tra le parole",
          Version: "Versione",
          "Assets can only be sent within the same chain.":
            "Gli asset possono essere inviati solo all'interno della stessa rete.",
          ...
          "Enter PIN to Connect": "Inserisci PIN per connetterti",
          "Use the PIN code to connect securely to your device.":
            "Usa il codice PIN per collegarti in sicurezza al tuo dispositivo.",
          ...
          "Your secure and intuitive companion app.":
            "La tua app sicura e intuitiva.",
          "Screen lock enabled successfully":
            "Blocco schermo attivato con successo",
          "Success!": "Successo!",
          "Enable Face ID": "Attiva Face ID",
          "I lost my password": "Ho perso la password",
          "To reset the app and remove stored data, please uninstall and reinstall it on your phone.":
            "Per ripristinare l'app e rimuovere i dati salvati, disinstallala e reinstallala sul tuo telefono.",
          "Estimated value (US$)": "Valore stimato (US$)",
          Fee: "Commissione",
          "Waiting for approval on your device...":
            "In attesa di approvazione sul dispositivo...",
          "Verifying address on your device...":
            "Verifica indirizzo sul dispositivo...",
          "Your device is already verified.":
          ...
          "Robust security designed for your information.":
            "Sicurezza robusta progettata per proteggere le tue informazioni.",
          "Easily manage multiple asset types.":
          ...
          "Fetching address...": "Recupero indirizzo in corso...",
          Devices: "Dispositivi",
          ...
          Warning: "Avviso",
          deleteDeviceConfirmMessage:
            "Sei sicuro di voler rimuovere questo dispositivo dall'app?\nCiò eliminerà tutte le informazioni locali relative al dispositivo.\n\nPuoi riconnettere il dispositivo in seguito per sincronizzare nuovamente i dati.\nAssicurati di salvare tutte le informazioni importanti prima di continuare.",
          Delete: "Elimina",
          Success: "Successo",
          ...
          Edit: "Modifica",
          Chain: "Rete",
          "All Chains": "Tutte le reti",
          "Contact Support via Email": "Contatta il supporto via email",
          addressShown: "Indirizzo mostrato correttamente sul dispositivo.",
          "Search Address": "Cerca indirizzo",
          "No device paired. Please pair with device first.":
            "Nessun dispositivo associato. Associa prima un dispositivo.",
          All: "Tutti",
      ...
      vi: {
        translation: {
          ...
          "Help & Support": "Hỗ trợ & Trợ giúp",
          "Privacy & Data": "Quyền riêng tư & Dữ liệu",
          About: "Giới thiệu",
          Language: "Ngôn ngữ",
          "Dark Mode": "Chế độ tối",
          Bluetooth: "Bluetooth",
          "Manage Paired Devices": "Quản lý thiết bị đã ghép đôi",
          "LOOKING FOR DEVICES": "ĐANG TÌM THIẾT BỊ",
          "Scanning...": "Đang quét...",
          "Please make sure your Cold Wallet is unlocked and Bluetooth is enabled.":
            "Vui lòng đảm bảo ví lạnh đã được mở khóa và Bluetooth đã bật.",
          Send: "Gửi",
          Receive: "Nhận",
          ...
          Balance: "Số dư",
          "No assets available. Please connect your device to continue.":
            "Không có tài sản. Vui lòng kết nối thiết bị để tiếp tục.",
          "This asset card will be removed": "Thẻ tài sản này sẽ bị xóa",
          "Remove Asset Card": "Xoá thẻ tài sản",
          Remove: "Xoá",
          ...
          "Encrypting your data": "Đang mã hóa dữ liệu",
          "Let's Go": "Bắt đầu ngay",
          "Use spaces between words": "Sử dụng dấu cách giữa các từ",
          Version: "Phiên bản",
          "Assets can only be sent within the same chain.":
            "Tài sản chỉ có thể gửi trong cùng một chuỗi.",
          "Firmware Update": "Cập nhật firmware",
          "No data available": "Không có dữ liệu",
          "Search Currency": "Tìm loại tiền",
          "Search Asset": "Tìm tài sản",
          "Enable Screen Lock": "Bật khoá màn hình",
          "Enter new password": "Nhập mật khẩu mới",
          "Confirm new password": "Xác nhận mật khẩu mới",
          "Change App Screen Lock Password": "Thay đổi mật khẩu khoá màn hình",
          "Disable Lock Screen": "Tắt khoá màn hình",
          "Enter your password": "Nhập mật khẩu của bạn",
          "Enter Password to Unlock": "Nhập mật khẩu để mở khoá",
          ...
          "Use the PIN code to connect securely to your device.":
            "Sử dụng mã PIN để kết nối an toàn với thiết bị.",
          "Enter PIN": "Nhập PIN",
          "Verification successful!": "Xác minh thành công!",
          "You can now safely use the device.":
            "Bạn có thể sử dụng thiết bị an toàn.",
          ...
          "Screen lock enabled successfully": "Khoá màn hình đã bật thành công",
          "Success!": "Thành công!",
          "Enable Face ID": "Bật Face ID",
          "I lost my password": "Tôi quên mật khẩu",
          "To reset the app and remove stored data, please uninstall and reinstall it on your phone.":
            "Để đặt lại ứng dụng và xoá dữ liệu, vui lòng gỡ cài đặt và cài lại.",
          "Estimated value (US$)": "Giá trị ước tính (US$)",
          Fee: "Phí",
          "Verifying address on your device...":
            "Đang xác minh địa chỉ trên thiết bị...",
          "Your device is already verified.": "Thiết bị đã được xác minh.",
          "Address Book": "Sổ địa chỉ",
          Convert: "Chuyển đổi",
          Skip: "Bỏ qua",
          "Start Exploring": "Khám phá ngay",
          "Secure and Reliable": "An toàn và tin cậy",
          "Robust security designed for your information.":
            "Bảo mật mạnh mẽ được thiết kế cho dữ liệu của bạn.",
          "Manage Your Assets": "Quản lý tài sản của bạn",
          "Easily manage multiple asset types.":
            "Dễ dàng quản lý nhiều loại tài sản.",
          Welcome: "Chào mừng",
          "Your secure and intuitive companion app.":
            "Ứng dụng đồng hành an toàn và dễ sử dụng.",
          "Address Copied to Clipboard": "Địa chỉ đã sao chép vào clipboard",
          ...
          OK: "OK",
          "The address of device": "Địa chỉ thiết bị",
          is: "là",
          "The address has been copied to your clipboard.":
            "Địa chỉ đã được sao chép vào clipboard.",
          "Permission denied, unable to access device location":
            "Từ chối quyền truy cập vị trí thiết bị",
          "Last connected": "Lần kết nối cuối",
          "Secure Device Status": "Tình trạng thiết bị",
          "Device Settings": "Cài đặt thiết bị",
          "Reset Local Profile": "Đặt lại hồ sơ cục bộ",
          Support: "Hỗ trợ",
          Warning: "Cảnh báo",
          deleteDeviceConfirmMessage:
            "Bạn có chắc chắn muốn gỡ thiết bị này khỏi ứng dụng?\nThao tác này sẽ xoá mọi dữ liệu cục bộ liên quan đến thiết bị.\n\nBạn có thể kết nối lại thiết bị để đồng bộ.\nHãy đảm bảo bạn đã sao lưu thông tin quan trọng trước khi tiếp tục.",
          Delete: "Xoá",
          Success: "Thành công",
          ...
          addressShown: "Địa chỉ đã được hiển thị trên thiết bị.",
          "Search Address": "Tìm địa chỉ",
          "No device paired. Please pair with device first.":
            "Chưa có thiết bị được ghép nối. Vui lòng ghép nối trước.",
          All: "Tất cả",
      ...
      id: {
        translation: {
          ...
          "Default Currency": "Mata Uang Baku",
          ...
          Bluetooth: "Bluetooth",
          "Manage Paired Devices": "Kelola Perangkat Tersambung",
          "LOOKING FOR DEVICES": "MENCOCOKKAN PERANGKAT",
          "Scanning...": "Memindai...",
          "Please make sure your Cold Wallet is unlocked and Bluetooth is enabled.":
          ...
          "Let's Go": "Ayo Mulai",
          "Use spaces between words": "Gunakan spasi antar kata",
          Version: "Versi",
          "Assets can only be sent within the same chain.":
          ...
          "Change App Screen Lock Password": "Ubah Kata Sandi Kunci Aplikasi",
          ...
          "Use the PIN code to connect securely to your device.":
            "Gunakan PIN untuk terhubung dengan aman ke perangkat Anda.",
          ...
          "Your secure and intuitive companion app.":
            "Aplikasi pendamping aman dan intuitif.",
          ...
          "To reset the app and remove stored data, please uninstall and reinstall it on your phone.":
            "Untuk mereset aplikasi dan menghapus data, uninstall dan pasang kembali di ponsel Anda.",
          "Estimated value (US$)": "Perkiraan Nilai (US$)",
          Fee: "Biaya",
          "Waiting for approval on your device...":
            "Menunggu persetujuan pada perangkat Anda...",
          "Verifying address on your device...":
          ...
          "Robust security designed for your information.":
            "Keamanan kokoh untuk informasi Anda.",
          "Easily manage multiple asset types.":
            "Kelola banyak jenis aset dengan mudah.",
          ...
          Warning: "Peringatan",
          deleteDeviceConfirmMessage:
            "Anda yakin ingin menghapus perangkat ini dari aplikasi? Ini akan menghapus semua informasi tersimpan lokal.\n\nAnda bisa menghubungkannya lagi nanti untuk menyinkronkan data.\nPastikan simpan semua data penting sebelum melanjutkan.",
          Delete: "Hapus",
          Success: "Berhasil",
          "Deleted successfully.": "Berhasil dihapus.",
          "Not enough value": "Nilai tidak mencukupi",
          Save: "Simpan",
          Address: "Alamat",
          ...
          "No device paired. Please pair with device first.":
            "Belum ada perangkat dipasangkan. Harap pasangkan terlebih dahulu.",
          All: "Semua",
