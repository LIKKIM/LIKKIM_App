    ...
    resources: {
      ...
      ko: {
        translation: {
          ...
          "Enter Password to Unlock": "잠금 해제할 비밀번호 입력",
          ...
          "I lost my password": "비밀번호를 잊어버렸어요",
          "To reset the app and remove stored data, please uninstall and reinstall it on your phone.":
            "앱을 재설정하고 저장된 데이터를 제거하려면 휴대폰에서 앱을 제거한 후 다시 설치하세요.",
          "Estimated value (US$)": "예상 가치 (US$)",
          Fee: "수수료",
          "Waiting for approval on your device...": "장치 승인 대기 중...",
          ...
          "Reset Local Profile": "로컬 프로필 재설정",
          Support: "지원",
          Warning: "경고",
          deleteDeviceConfirmMessage:
            "이 장치를 앱에서 제거하시겠습니까?\n이렇게 하면 이 장치와 관련된 모든 로컬 저장 정보가 삭제됩니다.\n\n나중에 장치를 다시 연결하여 데이터를 동기화할 수 있습니다.\n계속하기 전에 중요한 정보가 저장되었는지 확인하세요.",
          Delete: "삭제",
          Success: "성공",
          "Deleted successfully.": "성공적으로 삭제되었습니다.",
          "Not enough value": "값이 부족합니다",
          Save: "저장",
          Address: "주소",
          "Add Address": "주소 추가",
          Network: "네트워크",
